      ...
      authentication, async (user: User | null) => {
        ////console.log('onIdTokenChanged', user);
          if (!user) {
            ...
            nookies.set(undefined, '_session', token, { path: '/', maxAge: 60*60*24*14});
            nookies.set(undefined, 'session', token, { path: '/', maxAge: 60*60*24*14});
            nookies.set(undefined, '__session', token, { path: '/', maxAge: 60*60*24*14});
