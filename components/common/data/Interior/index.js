...
export const bannerData = {
  ...
  text2: 'You can engage with companies already in your portfoilio now or sign up below to get an alert when more features are released. We promise not to spam your email!',
  carousel: [
    {
      id: 1,
      thumb_url: slide1,
