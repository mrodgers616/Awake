    ...
    >
      ...
      <ModalContent>
        ...
        >
          <Center>
            <Stack>
              <Text align="center">Creating an account and linking a brokerage account differentiates your vote from other platforms and helps to make an acutal impact</Text>
              <Center>
